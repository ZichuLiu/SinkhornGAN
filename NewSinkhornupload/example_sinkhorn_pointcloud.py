...
l1, pi = spc.sinkhorn_loss(X, Y, epsilon, n, niter)
l2, _ = spc.sinkhorn_normalized(X, Y, epsilon, n, niter)

print("Sinkhorn loss : ", l1.data.item())
print("Sinkhorn loss (normalized) : ", l2.data.item())
