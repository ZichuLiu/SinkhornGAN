...
def sink(α_i, x_i, β_j, y_j, p=2, eps=.5, nits=100, tol=1e-3, assume_convergence=True, heatmaps=None, **kwargs):
...
def sym_sink(α_i, x_i, y_j=None, p=2, eps=.5, nits=100, tol=1e-3, assume_convergence=True, heatmaps=None, **kwargs):
    ε = eps  # Python supports Unicode. So fancy!
